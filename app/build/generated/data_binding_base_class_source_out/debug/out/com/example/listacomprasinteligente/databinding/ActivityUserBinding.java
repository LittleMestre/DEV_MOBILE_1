...
public final class ActivityUserBinding implements ViewBinding {
  ...
  private ActivityUserBinding(@NonNull RelativeLayout rootView, @NonNull Button btnEnter,
      @NonNull EditText editName, @NonNull ImageView imageLogo, @NonNull RelativeLayout main,
  ...
  public static ActivityUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUserBinding((RelativeLayout) rootView, btnEnter, editName, imageLogo, main,
